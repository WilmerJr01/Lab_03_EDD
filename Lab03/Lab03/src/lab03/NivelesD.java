...
public class NivelesD extends javax.swing.JFrame {
    ...
    public NivelesD(int time, String PreguntaFormulada, double RespuestaCorrecta, int NumPregunta, MultiList multiList, LinkedList RespuestasTurno) {
        this.multiList = multiList;
        if (NumPregunta == 60) {
            ArrayList<Boolean> sublist4 = new ArrayList<>();
            this.multiList.addSublist(sublist4);
        }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(61, 178, 75));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        Correcto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lab03/Imagenes/aprobar.png"))); // NOI18N
        jPanel1.add(Correcto, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 340, -1, -1));

        Error.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lab03/Imagenes/cancelar (3).png"))); // NOI18N
        jPanel1.add(Error, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 340, -1, -1));
        ...
        TiempoLbl.setText("0");
        jPanel1.add(TiempoLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 60, -1, -1));

        ComprobarBtn.setBackground(new java.awt.Color(61, 178, 75));
        ...
        jPanel1.add(ComprobarBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 380, -1, -1));

        BarraDeTiempo.setBackground(new java.awt.Color(255, 255, 255));
        BarraDeTiempo.setForeground(new java.awt.Color(61, 178, 75));
        ...
        PreguntaLbl.setForeground(new java.awt.Color(61, 178, 75));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 150, 420, 130));
        ...
        RespuestaDada.setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 1, 14)); // NOI18N
        RespuestaDada.setRows(1);
        RespuestaDada.setTabSize(1);
        RespuestaDada.setToolTipText("");
        jScrollPane1.setViewportView(RespuestaDada);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 290, 230, 40));
        ...
        jPanel1.add(RespuestaLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 420, -1, -1));
        ...
        jPanel1.add(TituloRespuesta, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 370, -1, -1));
    ...
    private void ComprobarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComprobarBtnActionPerformed
        ...
        if (RespuestaCorrecta == RD) {
            ...
            multiList.addElementToSublist(3, true);
            ...
            multiList.addElementToSublist(3, false);
            progressNew = progress + 5;
            if (progressNew > 40) {
                progressNew = 40;
            }
        ...
        Timer delayTimer = new Timer(3000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (NumPregunta + 1 >= 61 && NumPregunta <=70) {
                    vector = logica.operacioneslvl7(NumPregunta + 1);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NivelesD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new NivelesD(0, Pregunta, Respuesta, 0, multiList, linkedL).setVisible(true);
            }
        });
    }
